...
class ChatbotthreeScreen extends StatelessWidget {
  ChatbotthreeScreen({Key? key})
      : super(
          key: key,
        );

  TextEditingController askmeanythingvaController = TextEditingController();
        ...
        body: SizedBox(
          ...
          child: Column(
            children: [
              ...
              CustomImageView(
                imagePath: ImageConstant.img20200517111004104339x254,
                height: 339.v,
                width: 254.h,
              ),
              SizedBox(height: 9.v),
              ...
              Padding(
                ...
                child: CustomTextFormField(
                  controller: askmeanythingvaController,
